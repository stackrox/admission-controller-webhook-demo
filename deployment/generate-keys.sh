...
# The certificate will be issued for the Common Name (CN) of `tigera-init-injector.tigera-init-injector.svc`, which is the
...
openssl req -new -key webhook-server-tls.key -subj "/CN=tigera-init-injector.tigera-init-injector.svc" \
